...
这里采用最新的spirngboot版本了,目前官网GA(GA:General Availability,正式发布的版本)版本是2.0.4的。  
https://spring.io/projects/spring-boot#learn

新的2.1.0版本也有了。2.0.5版本也有。
...
<beans xmlns="http://www.springframework.org/schema/beans"
    ...
    <bean id="helloService" class="com.mage.springboot.service.HelloService"></bean>
</beans>
```
...
[参考官方文档](https://docs.spring.io/spring-boot/docs/2.0.4.RELEASE/reference/htmlsingle/#boot-features-external-config)
...
[配置文件能配置的属性参照](https://docs.spring.io/spring-boot/docs/2.0.4.RELEASE/reference/htmlsingle/#common-application-properties)
...
public class MyMvcConfig extends WebMvcConfigurerAdapter {
    ...
    public void addViewControllers(ViewControllerRegistry registry) {
       // super.addViewControllers(registry);
        //浏览器发送 /mage 请求来到 success
        registry.addViewController("/mage").setViewName("success");
    }
}
```
...
<form>
    ...
    <div class="form-group">
        <label>Email</label>
        <input type="email" class="form-control" placeholder="zhangsan@mage.com">
    </div>
    <div class="form-group">
...
-->
    ...
    <div class="form-group">
        <label>Email</label>
        <input name="email" type="email" class="form-control" placeholder="zhangsan@mage.com" th:value="${emp!=null}?${emp.email}">
    </div>
    <div class="form-group">
        <label>Gender</label><br/>
        <div class="form-check form-check-inline">
...
com.mage.springboot.listener.HelloApplicationContextInitializer

org.springframework.boot.SpringApplicationRunListener=\
com.mage.springboot.listener.HelloSpringApplicationRunListener
```
...
<project xmlns="http://maven.apache.org/POM/4.0.0"
    ...
    <groupId>com.mage.starter</groupId>
    <artifactId>mage-spring-boot-starter</artifactId>
    ...
    <dependencies>
        ...
        <dependency>
            <groupId>com.mage.starter</groupId>
            <artifactId>mage-spring-boot-starter-autoconfigurer</artifactId>
...
<project xmlns="http://maven.apache.org/POM/4.0.0" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance"
   ...
   <name>mage-spring-boot-starter-autoconfigurer</name>
...
```java
package com.mage.starter;

import org.springframework.boot.context.properties.ConfigurationProperties;

@ConfigurationProperties(prefix = "mage.hello")
